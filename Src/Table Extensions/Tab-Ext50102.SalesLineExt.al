tableextension 50102 SalesLineExt extends "Sales Line"
{
    fields
    {
    ...
    begin
        ...
        if ManifestLine.FindFirst() then begin
            ...
            rec.ValidateShortcutDimCode(3, ManifestLine."Shortcut Dimension 3 Code");
            Rec.ValidateShortcutDimCode(4, ManifestLine."Shortcut Dimension 4 Code");
            Rec.ValidateShortcutDimCode(5, ManifestLine."Shortcut Dimension 5 Code");
            Rec.ValidateShortcutDimCode(6, ManifestLine."Shortcut Dimension 6 Code");
            rec.Modify();
        end;
    end;
