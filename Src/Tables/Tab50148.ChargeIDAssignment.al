table 50148 "Charge ID Assignment"
{
    ...
    fields
    {
        ...
        field(5; "Unit Type Container type/Vehic"; Enum ContainerTypeEnum)
        {
            Caption = 'Unit Type Container type or Vehicle';
            DataClassification = ToBeClassified;
            trigger OnValidate()
            begin
                Rec.TestStatusOpen();
        ...
        field(6; "Destination Local or Transit"; Enum DestinationTypeEnum)
        {
            Caption = 'Destination Local or Transit';
            DataClassification = ToBeClassified;
            trigger OnValidate()
            begin
                Rec.TestStatusOpen();
        ...
        // field(7; "File Type"; Enum ManifestClientTypeEnum)
        // {
        //     Caption = 'File Type';
        //     DataClassification = ToBeClassified;
        // }
    ...
    keys
    {
        key(PK; "Customer No.", "Charge Id Group Code", "Shortcut Dimension 5 Code", "Destination Local or Transit", "Global Dimension 2 Code")
        {
            Clustered = true;
        }
    }
