table 50123 Verification
{
    ...
    fields
    {
        field(1; "Verification No."; Code[10])
        {
        ...
        field(14; Verified; Boolean)
        {
            Caption = 'Verified';
            DataClassification = ToBeClassified;
        }
        field(15; "Job File No."; code[20])
        {
            Caption = 'Job File No.';
            DataClassification = ToBeClassified;
            Editable = false;
        ...
        field(16; "Manifest Line No."; Integer)
        {
