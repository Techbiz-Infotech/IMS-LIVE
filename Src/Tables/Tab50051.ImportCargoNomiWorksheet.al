table 50051 "Import Cargo Nomi Worksheet"
{
    Caption = 'Import Cargo Nomination Worksheet';
    ...
    var
        ImportWS: Record "Import Cargo Nomi Worksheet";
        strtxt: text;
    ...
    procedure ImportCargoNominationValidate()
    var
        Lenth: Integer;
        ...
        ImportWS3, ImportWS2, ImportWS : Record "Import Cargo Nomi Worksheet";
    ...
    procedure CreateNomination()
    var
        CargoNomination: Record "Cargo Nomination";
        NoSeriesMgt: Codeunit "No. Series";
        IMSSetup: Record "Ims Setup";
        LineNo: Integer;
        ImportWs, ImportWS2 : Record "Import Cargo Nomi Worksheet";
        JobFileNo: Code[20];
        BlNo: Code[20];
    begin
        IMSSetup.Get();
        ...
        if not Confirm('Do you want to create Cargo Nomination from Import Worksheet?', false) then
            exit;
        ImportWs.Reset();
        // ImportWs.SetRange("Job File No.", JobFileNo);
        if ImportWs.FindFirst() then
            repeat
                ...
                CargoNomination.SetRange("Cargo Nomination No.", ImportWs."Job File No.");
                if CargoNomination.FindLast() then
                    LineNo := CargoNomination."Line No." + 10000
                else
                    LineNo := 10000;
                CargoNomination.Init();
                CargoNomination.Validate("Cargo Nomination No.", ImportWs."Job File No.");
                CargoNomination."Line No." := LineNo;
                CargoNomination.Insert();
                CargoNomination.Validate("BL No.", ImportWs."BL No.");
                CargoNomination.Validate("CBM Tonage", ImportWs."CBM Tonage");
                CargoNomination."Container Id" := ImportWs."Container ID";
                CargoNomination."Job File Date" := ImportWs."Job File Date";
                //SH
                ...
                CargoNomination.Validate("Cargo Type", ImportWs."Cargo Type");
                //MFLine.Validate("Shortcut Dimension 5 Code", ImportWs."Container size");
                CargoNomination.Validate("Process Type", ImportWs."Process Type");
                CargoNomination.Validate("Clearing Agent", ImportWs."Clearing Agent");
                CargoNomination.Validate("Consignee No.", ImportWs."Consignee No.");
                CargoNomination.Validate("Seal/Engine No.", ImportWs."Seal/Engine No.");
                Evaluate(CargoNomination."Destination Type", ImportWs."Destination Type");
                Evaluate(CargoNomination."Container Type", ImportWs."Container Type");
                Evaluate(CargoNomination."Client Type", ImportWs."Client Type");
                CargoNomination.Validate(Weight, ImportWs.Weight);
                CargoNomination.Validate("Container size", ImportWs."Container size");
                CargoNomination.Validate("Invoicing Party No.", ImportWs."Invoicing Party No.");
                CargoNomination.Validate("Port of Discharge", ImportWs."Port of Discharge");
                CargoNomination.Validate("Port of Shipment", ImportWs."Port of Shipment");
                CargoNomination.Validate("Container/Chassis No.", ImportWs."Container/Chassis No.");
                CargoNomination.Validate(Description, ImportWs.Description);
                CargoNomination.Validate("Shipping Agent", ImportWs."Shipping Agent");
                CargoNomination.Validate("Vessel Name", ImportWs."Vessel Name");
                //MFLine.Validate("Voyage No.", ImportWs."Voyage No.");
                CargoNomination.Validate("Expected Arrival Date", ImportWs."Expected Arrival Date");
                CargoNomination.Validate("Vessel Arrival Date", ImportWs."Vessel Arrival Date");
                //MFLine.Validate("Vessel Arrival Time", ImportWs."Vessel Arrival Time");
                CargoNomination.Validate("Last Sling Date", ImportWs."Last Sling Date");
                CargoNomination.Validate("Client Type", ImportWs."Client Type");
                CargoNomination.Validate("Parent Container ID", ImportWs."Parent Container ID");
                Evaluate(CargoNomination."TBL/MH", ImportWs."TBL/MH");
                CargoNomination.Modify();
            //InsertDimensionValues(ImportWs."Container ID", MFLine);
            until ImportWs.Next() = 0;
        ImportWs.DeleteAll();
        Message('Import completed successfully.Cargo Nomination line(s) created.');
    end;

    // procedure InsertDimensionValues(ContainerID: Code[20]; ImportWS: Record "Cargo Nomination")
    // var
    ...
    //         DimValueRec.Validate("Job File No.", ImportWS."Cargo Nomination No.");
