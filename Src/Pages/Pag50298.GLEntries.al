    ...
    layout
    {
        area(Content)
        {
            repeater(General)
            {
                ...
                {
                    ToolTip = 'Specifies the value of the Prepayment Reversed field.', Comment = '%';
                }
                field("IMS Document Type"; Rec."IMS Document Type")
                {
                    ToolTip = 'Specifies the value of the IMS Document Type field.', Comment = '%';
                }
