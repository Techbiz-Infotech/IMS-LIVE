page 50116 "proforma Invoice List"
{


    ApplicationArea = Basic, Suite, Assembly;
    Caption = 'Proforma Invoices';
    CardPageID = "proforma Invoice";
    ...
    SourceTableView = SORTING("Document Type", "No.") ORDER(Descending) WHERE("Document Type" = CONST(Order), Closed = const(false), Warehouse = const(false));
    UsageCategory = Lists;
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the BL No.';
                }
                field("Job File Date"; rec."Job File Date")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the Job file date';
                }
                field("Job File No."; Rec."Job File No.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the Job File No.';
                }
        ...
        area(processing)
        {
            ...
            group("&Order Confirmation")
            {
                ...
                action("Print Confirmation")
                {
                    ...
                    ToolTip = 'Print Proforma Invoice. A report request window opens where you can specify what to include on the print-out.';
