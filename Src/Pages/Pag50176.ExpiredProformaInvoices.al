page 50176 "Expired Proforma Invoice List"
{
    ApplicationArea = Basic, Suite, Assembly;
    Caption = 'Expired Proforma Invoices';
    InsertAllowed = false;
    DataCaptionFields = "Sell-to Customer No.";
    Editable = false;
    PageType = List;
    CardPageId = ClosedProformaCard;
    ...
    SourceTableView = SORTING("Document Type", "No.") ORDER(Descending) WHERE("Document Type" = CONST(Order), Closed = const(true), Expired = const(true));
    UsageCategory = Lists;
