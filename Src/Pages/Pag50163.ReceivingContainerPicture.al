page 50163 "Receiving Container Picture"
{
    ...
    //                     ExportPath := TemporaryPath + "Global Dimension 1 Code" + Format(Image.MediaId);
    ...
    //     local procedure UpdateReceivingLog()
    //     var
    //         myInt: Integer;
    //     begin
