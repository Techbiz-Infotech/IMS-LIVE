report 50153 "Purchase Order"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Src/Reports/Layouts/Purchase Order.rdlc';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            //IMS-New
            column(ApproveID; ApproveID) { }
            column(ApproveDate; ApproveDate) { }
            column(TotalInclVATLbl; TotalInclVATLbl) { }
            column(TotalVatLbl; TotalVatLbl) { }
            column(SystemCreatedBy; "Created By User ID") { }
            //IMS-NEW
            ...
            //IMS-NEW
            column(SrNoCaptionLbl; SrNoCaptionLbl) { }
            column(FileReferenceCaptionLbl; FileReferenceCaptionLbl) { }
            ...
            column(unitCostCaptionLbl; unitCostCaptionLbl) { }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(ShipToAddr1; ComAddre_gTxtArr[1])
                    {
                    }
                    column(ShipToAddr2; ComAddre_gTxtArr[2])
                    {
                    }
                    column(ShipToAddr3; ComAddre_gTxtArr[3])
                    {
                    }
                    column(ShipToAddr4; ComAddre_gTxtArr[4])
                    {
                    }
                    column(ShipToAddr5; ComAddre_gTxtArr[5])
                    {
                    }
                    column(ShipToAddr6; ComAddre_gTxtArr[6])
                    {
                    }
                    column(ShipToAddr7; ComAddre_gTxtArr[7])
                    {
                    }
                    column(ShipToAddr8; ComAddre_gTxtArr[8])
                    {
                    }
                    ...
                    column(ShipmentMethodDesc; Currencycode_gCode)
                    {
                    }
                    ...
                    //IMS-New
                    column(ShipviaCaptionLbl; ShipviaCaptionLbl) { }
                    column(RequestedByCaptionLbl; RequestedByCaptionLbl) { }
                    column(DepartmentCaptionLbl; DepartmentCaptionLbl) { }
                    column(ExpectedCaptionLbl; ExpectedCaptionLbl) { }
                    column(RemarkscaptonLbl; RemarkscaptonLbl) { }
                    column(AuthorisedCaptioLbl; AuthorisedCaptioLbl) { }
                    column(DateCaptionLbl; DateCaptionLbl) { }
                    column(MangingDirectorLbl; MangingDirectorLbl) { }
                    column(MDsSignatureLbl; MDsSignatureLbl) { }
                    column(ShiptoAddressCaption; ShiptoAddressCaptionLbl) { }
                    column(Desc_PurchLineCaptionLbl; Desc_PurchLineCaptionLbl) { }
                    column(Qty_PurchLineCaptionLbl; Qty_PurchLineCaptionLbl) { }
                    //IMS-new
                    ...
                    //IMS-New
                    column(VendorAddressCaptionLbl; VendorAddressCaptionLbl) { }
                    column(DocumentnamecaptionLbl; DocumentnamecaptionLbl) { }
                    //IMS-New
                    ...
                    dataitem(DimensionLoop1; "Integer")
                    {
                        ...
                        begin
                            ...
                            //     ApprovalEntry.SetRange(Status::Approved);
                            //     IF ApprovalEntry.FindLast() then begin
                            //         ApproveID := ApprovalEntry."Approver ID";
                            //         ApproveDate := ApprovalEntry."Last Date-Time Modified";
                            //     end;
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(VAT_PurchLine; PurchLine."VAT %") { }
            ...
            begin
                ...
                REPEAT
                    Cnt_iInt += 1;
                    ComAddre_gTxtArr[Cnt_iInt] := CompanyAddr[Cnt_iInt];
                UNTIL CompanyAddr[Cnt_iInt] = '';
                //ComAddre_gTxtArr[Cnt_iInt + 1] := 'Email: ' + CompanyInfo."E-Mail";
                //ComAddre_gTxtArr[Cnt_iInt + 2] := 'Website: ' + CompanyInfo."Home Page";
                //ComAddre_gTxtArr[Cnt_iInt + 3] := 'TEL: ' + CompanyInfo."Phone No." + ' FAX :' + CompanyInfo."Fax No.";
                ;
                //ComAddre_gTxtArr[Cnt_iInt + 4] := 'UEN: ' + CompanyInfo."VAT Registration No." + '/' + 'GST Reg No.: ' + CompanyInfo."VAT Registration No.";
                //ComAddre_gTxtArr[Cnt_iInt + 5] := 
                //ComAddre_gTxtArr[Cnt_iInt + 6] := ;
                ...
                IF "Purchase Header"."Currency Code" <> '' then
                    Currencycode_gCode := "Purchase Header"."Currency Code"
                Else
                    Currencycode_gCode := GLSetup."LCY Code";
            end;
                ...
                if "Purchase Header".FindSet() then
                    repeat
                        if "Purchase Header".Status = "Purchase Header".Status::Open then
                            Error('You cannot print this report unless the Purchase Order is Released.');
    ...
    var
        ...
        Cnt_iInt: Integer;
        ComAddre_gTxtArr: array[12] of Text[100];
        TotalAmount: Decimal;
        ...
        PurchLineLineDiscCaptionLbl: Label 'Total VAT%';
        VATDiscountAmountCaptionLbl: Label 'Payment Discount on VAT';
        LineDimCaptionLbl: Label 'Line Dimensions';
        PaymentDetailsCaptionLbl: Label 'Payment Details';
        VendNoCaptionLbl: Label 'Vendor No.';
        ShiptoAddressCaptionLbl: Label 'Ship-To: ';
        ...
        DocumentnamecaptionLbl: Label 'Purchase Order';
        VendorAddressCaptionLbl: Label 'Vendor Address:';
        RequestedByCaptionLbl: Label 'Requested By';
        DepartmentCaptionLbl: Label 'Deptt';
        ShipviaCaptionLbl: Label 'Ship Via';
        ExpectedCaptionLbl: Label 'Expected Date';
        SrNoCaptionLbl: Label 'Item No.';
        unitCostCaptionLbl: Label 'Unit Cost';
        TotalAmountcaptionLbl: Label 'Total Amt(Exl.VAT)';
        RemarkscaptonLbl: Label 'Remarks:';
        AuthorisedCaptioLbl: Label 'General manager ';
        DateCaptionLbl: Label 'Date';
        MangingDirectorLbl: Label 'Managing Director';
        VatCaptionLbl: Label 'VAT%';
        TotalVatLbl: Label 'Total VAT';
        TotalInclVATLbl: Label 'Total Incl.VAT';
        MDsSignatureLbl: Label 'Chief Accountant';
        FileReferenceCaptionLbl: Label 'File Reference';
        Desc_PurchLineCaptionLbl: Label 'Description';
        Qty_PurchLineCaptionLbl: Label 'Quantity';
        VATAmtLineVATCaptionLbl: Label 'Total Amt Incl.VAT';
        ...
        PaymentTermsDescCaptionLbl: Label 'Terms';
