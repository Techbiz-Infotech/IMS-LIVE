report 50118 "Bank Payment Voucher"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Src/Reports/Layouts/Bank Payment Voucher.rdlc';
    ...
    dataset
    {
        ...
        dataitem("G/L Entry"; "G/L Entry")
        {
            ...
            column(G_L_Entry_Additional_Currency_Amount; "Additional-Currency Amount")
            {
                //AutoCalcField = true;
            }
            ...
            column(G_L_Exter_DocNo_CaptionLbl; G_L_Exter_DocNo_CaptionLbl)
            { }
    ...
    var
        ...
        G_L_Exter_DocNo_CaptionLbl: Label 'Ext Doc No./Check No.';
        ...
        AmountFCYCaptionLbl: Label 'Amount (FCY)';
