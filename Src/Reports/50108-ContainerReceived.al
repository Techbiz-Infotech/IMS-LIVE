report 50108 "Container Received"
{
    ...
    begin
        ...
        TempExcelBuffer.AddColumn('Container Received', FALSE, '', TRUE, FALSE, TRUE, '', TempExcelBuffer."Cell Type"::Text);
        TempExcelBuffer.NewRow();
    ...
    begin
        TempExcelBuffer.CreateNewBook('Container Received Report');
        TempExcelBuffer.WriteSheet('Container Received Report', CompanyName, UserId);

        TempExcelBuffer.CloseBook();
        TempExcelBuffer.SetFriendlyFilename('Container Received Report');
