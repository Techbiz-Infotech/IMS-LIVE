report 50174 "USD Budget"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Src/Reports/Layouts/USDBudget.rdlc';
    ApplicationArea = Suite;
    Caption = 'USD Budget by Period';
        ...
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            begin
                ...
                for i := 1 to ArrayLen(GLBudgetedAmount) do begin
                    ...
                    if ExchRate <> 0 then
                        GLBudgetedAmount[i] := MatrixMgt.RoundAmount("Budgeted Amount" / ExchRate, RndFactor)
                    else
    ...
    procedure RoundAmount1(Value: Decimal): Text[30]
    begin
    ...
    var
        ...
        BudgetCaptionTok: Label 'USD Budget for %1', Comment = '%1 - year';
