Report 50176 "Loading Slip MICT"
{
    UsageCategory = ReportsAndAnalysis;
    //ApplicationArea = all;
    DefaultLayout = RDLC;
    RDLCLayout = './Src/Reports/Layouts/Loading Slip Report MICT.rdlc';
    ...
    dataset
    {
        dataitem("Gate Pass Out"; "Gate Pass Out")
        {
            ...
            begin
                ...
                manifestLineInfo.SetRange("Job File No.", "Gate Pass Out"."Job File No.");
               // ManifestLineinfo.SetRange("Global Dimension 1 Code", "Gate Pass Out"."Global Dimension 1 Code");
                if manifestLineInfo.FindFirst() then;
