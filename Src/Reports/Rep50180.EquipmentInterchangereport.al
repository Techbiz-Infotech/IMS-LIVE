report 50180 "Equipment Interchange report"
{
    //ApplicationArea = All;
    Caption = 'Equipment Interchange report';
    UsageCategory = ReportsAndAnalysis;
    RDLCLayout = './Src/Reports/Layouts/EquipmentInterchangereport.rdlc';
    DefaultLayout = RDLC;
    dataset
    {
        dataitem(ReceivingLog; ReceivingLog)
        {
            ...
            column(Releasing_Clerk_Details; "Releasing Clerk Details") { }
            ...
            begin
                ManifestLine.Reset();
                ManifestLine.SetRange("Global Dimension 1 Code", ReceivingLog."Global Dimension 1 Code");
