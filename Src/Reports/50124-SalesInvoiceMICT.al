report 50124 "Sales Invoice - MICT"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Src/Reports/Layouts/SalesInvoiceMICT.rdlc';
    UsageCategory = ReportsAndAnalysis;
    //ApplicationArea = All;
    Caption = 'Sales-Invoice-MICT';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            { }
            column(VAT_Registration_No_; CustomerRec."VAT Registration No.") { }
            ...
            begin
                ...
                IF SalesInvoiceLine.findset() then begin
                    if (SalesInvoiceLine."Shortcut Dimension 1 Code" <> '') or (SalesInvoiceLine."BL No." <> '') then begin
