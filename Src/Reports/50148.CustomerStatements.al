report 50148 "Customer Statements IMS"
{
    Caption = 'Customer Statement - Open Entries';
    DefaultLayout = RDLC;
    RDLCLayout = './Src/Reports/Layouts/CustomerStatementsIMS.rdlc';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            dataitem(HeaderFooter; "Integer")
            {
                ...
                column(Payment_Terms_Code; Customer."Payment Terms Code") { }
                ...
                column(TempCustLedgEntry__SalesPersonCode_Caption; TempCustLedgEntry__SalesPersonCode_CaptionLbl)
                { }
                column(TempCustLedgEntry__BL_No_Caption; TempCustLedgEntry__BL_No_CaptionLbl) { }
                column(TempCustLedgEntry__Duedate_Caption; TempCustLedgEntry__Duedate_Captionlbl) { }
                column(TempCustLedgEntry__Amount_Caption; TempCustLedgEntry__Amount_Captionlbl) { }
                ...
                dataitem(OpenItem; "Integer")
                {
                    ...
                    //new
                    column(TempCustLedgEntry_Clearing_Agent_Name; TempCustLedgEntry."Clearing Agent Name") { }
                    column(TempCustLedgEntry_BL_No_; TempCustLedgEntry."BL No.") { }
                    column(TempCustLedgEntry_Due_Date; TempCustLedgEntry."Due Date") { }
                    column(TempCustLedgEntry_Salesperson_Code; TempCustLedgEntry."Salesperson Code") { }
                    //new
                    ...
                    begin
                        ...
                        TempCustLedgEntry.CalcFields("Clearing Agent Name");
                    end;
                ...
                dataitem(CustLedgerEntry4; "Cust. Ledger Entry")
                {
                    ...
                    begin
                        ...
                        CustLedgerEntry4.CalcFields("BL No.");
                        CustLedgerEntry4.CalcFields("Clearing Agent Name");
                    end;
    ...
    var
        ...
        GetTermsString_TempCustLedgEntry_CaptionLbl: Label 'Agent Name';
        ...
        TempCustLedgEntry__SalesPersonCode_CaptionLbl: Label 'Sales Person';
        TempCustLedgEntry__BL_No_CaptionLbl: Label 'BL No.';
        TempCustLedgEntry__Duedate_Captionlbl: Label 'Due date';
        TempCustLedgEntry__Amount_Captionlbl: Label 'Amount';
