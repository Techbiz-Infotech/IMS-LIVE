report 50104 "Consolidated Received"
{
    ...
    dataset
    {
        dataitem("Manifest Line"; "Manifest Line")
        {
            ...
            begin
                ...
                if CustomerNo <> '' then
                    setfilter("Consignee No.", CustomerNo);
    ...
    begin
        ...
        TempExcelBuffer.AddColumn('Received Report', FALSE, '', TRUE, FALSE, TRUE, '', TempExcelBuffer."Cell Type"::Text);
        TempExcelBuffer.NewRow();
        ...
        TempExcelBuffer.AddColumn('MICD Seal No.', FALSE, '', TRUE, FALSE, TRUE, '', TempExcelBuffer."Cell Type"::Text);
    ...
    begin
        TempExcelBuffer.CreateNewBook('Consolidated report');
        TempExcelBuffer.WriteSheet('Consolidated report', CompanyName, UserId);
        TempExcelBuffer.CloseBook();
        TempExcelBuffer.SetFriendlyFilename('Consolidated report');
