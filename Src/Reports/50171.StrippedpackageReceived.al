report 50171 "Stripped package Received"
{
    ApplicationArea = All;
    Caption = 'Stripped package Received';
    ...
    begin
        ...
        TempExcelBuffer.AddColumn('Stripped Package Received', FALSE, '', TRUE, FALSE, TRUE, '', TempExcelBuffer."Cell Type"::Text);
        TempExcelBuffer.NewRow();
    ...
    begin
        TempExcelBuffer.CreateNewBook('Stripped Package Received Report');
        TempExcelBuffer.WriteSheet('Stripped Package Received Report', CompanyName, UserId);

        TempExcelBuffer.CloseBook();
        TempExcelBuffer.SetFriendlyFilename('Stripped Package Received Report');
