report 50165 "IMS Purchase - Receipt"
{
    DefaultLayout = RDLC;

    Caption = 'Purchase - Receipt IMS';
    //PreviewMode = PrintLayout;
    UsageCategory = ReportsAndAnalysis;
    //ApplicationArea = all;
    RDLCLayout = './Src/Reports/Layouts/PurchaseReceipt.rdlc';
        ...
        dataitem("Purch. Rcpt. Header"; "Purch. Rcpt. Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Order_No1_; "Purch. Rcpt. Header"."Order No.")
                    { }
                    column(OrderNoCaptLbl; OrderNoCaptLbl) { }
                    column(ExpectedDateLbl; ExpectedDateLbl) { }
                    column(AuthorisedCaptioLbl; AuthorisedCaptioLbl) { }
                    column(Expectd_PurchRcptHdr; "Purch. Rcpt. Header"."Expected Receipt Date") { }
    ...
    var
        ...
        PaytoAddrCaptionLbl: Label 'Vendor Address:';
        DocDateCaptionLbl: Label 'Date';
        ExpectedDateLbl: Label 'Expected Date';
    ...
    begin
       ...
       // LogInteraction := SegManagement.FindInteractionTemplateCode(SegManagement.)<> '';
    end;
