report 50151 "Consolidated Stock "
{
    ApplicationArea = All;
    Caption = 'Consolidated Stock ';
    ...
    begin
        ...
        TempExcelBuffer.AddColumn('Consolidated Stock As on' + '  ' + Format(EndDate), false, '', true, false, true, '', TempExcelBuffer."Cell Type"::Text);
        TempExcelBuffer.NewRow();
    ...
    begin
        TempExcelBuffer.CreateNewBook('Consolidated Stock Status');
        TempExcelBuffer.WriteSheet('Consolidated Stock Status', CompanyName, UserId);
        TempExcelBuffer.CloseBook();
        TempExcelBuffer.SetFriendlyFilename('Consolidated Stock Status');
