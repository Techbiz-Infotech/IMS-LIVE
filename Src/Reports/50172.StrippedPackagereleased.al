report 50172 "Stripped Package released"
{
    ApplicationArea = All;
    Caption = 'Stripped Package Released';
    ...
    dataset
    {
        ...
        {
            DataItemTableView = SORTING("Job File No.") where("Shortcut Dimension 4 Code" = filter('STRIPPED PACKAGE'), Released = const(true));
    ...
    begin
        ...
        TempExcelBuffer.AddColumn('Stripped Package Released', FALSE, '', TRUE, FALSE, TRUE, '', TempExcelBuffer."Cell Type"::Text);
        TempExcelBuffer.NewRow();
    ...
    begin
        TempExcelBuffer.CreateNewBook('Stripped Package Released Report');
        TempExcelBuffer.WriteSheet('Stripped Package Released Report', CompanyName, UserId);
        TempExcelBuffer.CloseBook();
        TempExcelBuffer.SetFriendlyFilename('Stripped Package Released Report');
