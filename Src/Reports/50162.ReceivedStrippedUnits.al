report 50162 "Stripped Units Received"
{
    ApplicationArea = All;
    Caption = 'Stripped Units Received';
    ...
    begin
        ...
        TempExcelBuffer.AddColumn('Stripped Unit Received', FALSE, '', TRUE, FALSE, TRUE, '', TempExcelBuffer."Cell Type"::Text);
        TempExcelBuffer.NewRow();
    ...
    begin
        TempExcelBuffer.CreateNewBook('Stripped Units Received Report');
        TempExcelBuffer.WriteSheet('Stripped Units Received Report', CompanyName, UserId);

        TempExcelBuffer.CloseBook();
        TempExcelBuffer.SetFriendlyFilename('Stripped Units Received Report');
