report 50123 "Proforma Invoice- SICD"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Src/Reports/Layouts/ProformaInvoiceSICD.rdlc';
    //UsageCategory = ReportsAndAnalysis;
    //ApplicationArea = All;
    Caption = 'Proforma-Invoice SICD';
                    ...
                    if SalesLineRec.FindSet() then begin
                        repeat
                            if GroupByContainerID <> SalesLineRec."Shortcut Dimension 1 Code" then begin
                                ...
                                manifestLineInfo.Reset();
                                manifestLineInfo.SetRange("Global Dimension 1 Code", SalesLineRec."Shortcut Dimension 1 Code");
                                if manifestLineInfo.FindSet() then
                                    repeat
        ...
        dataitem("Sales Line"; "Sales Line")
        {
            ...
            begin
                ...
                if SalesLine2.FindFirst() then begin
                    ...
                    ActualStorageDays := SalesLine2."Storage Days" - Freedays;
                    if ActualStorageDays >= 0 then
                        StorageDays := ActualStorageDays
                    else
                        StorageDays := 0;
                end;
            end;
    ...
    var
       ...
       // manifestheaderInfo: Record "Manifest Header";
        ...
        RateExh: Decimal;
        ActualStorageDays, StorageDays, Freedays : Decimal;
        CurrencyCap: Code[20];
        TotalAmt: Decimal;
